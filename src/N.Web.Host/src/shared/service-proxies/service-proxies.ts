...
export class CartServiceProxy {
     ...
     * @return Success
     */
    addToCart(body: AddToCartDto | undefined): Observable<CartItemDto> {
        let url_ = this.baseUrl + "/api/services/app/Cart/AddToCart";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processAddToCart(response: HttpResponseBase): Observable<CartItemDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = CartItemDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
...
export class PersonServiceProxy {
     ...
     * @return Success
     */
    createOrEdit(body: CreateOrEditPersonDto | undefined): Observable<number> {
        let url_ = this.baseUrl + "/api/services/app/Person/CreateOrEdit";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    getAll(): Observable<CreateOrEditPersonDto[]> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<CreateOrEditPersonDto[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<CreateOrEditPersonDto[]>;
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<CreateOrEditPersonDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                ...
                for (let item of resultData200)
                    result200.push(CreateOrEditPersonDto.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
...
export class ProductCategoryServiceProxy {
     ...
     * @return Success
     */
    getProductCategoryDto(id: string | undefined): Observable<CreateOrEditProductCategoryDto> {
        let url_ = this.baseUrl + "/api/services/app/ProductCategory/GetProductCategoryDto?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetProductCategoryDto(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetProductCategoryDto(response_ as any);
                } catch (e) {
    ...
    protected processGetProductCategoryDto(response: HttpResponseBase): Observable<CreateOrEditProductCategoryDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
