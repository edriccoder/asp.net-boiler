...
{
    public abstract class NWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(NWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<NDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<NDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<NDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<NDbContext, Task<T>> func)
        {
            T result;
